...
export const Appbar = () => {
    return (
        <div className="border-b flex dark:bg-slate-800 justify-between px-10 py-4">
            <Link to={'/blogs'} className="flex flex-col text-3xl h-12 dark:text-white justify-center cursor-pointer">
                <span style={{ fontFamily: 'Anton' }}>JustWrite</span>
            </Link>

            <div className="flex items-center">

                <Link to={`/publish`}>
                    <button type="button" className="mr-4 text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5">
                        Write
                    </button>
                </Link>
